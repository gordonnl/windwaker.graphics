![](docs/assets/images/the-ocean/header.jpeg)
...
<video src="docs/assets/videos/the-ocean/reference.mp4" playsinline loop muted autoplay="autoplay"></video>

Here is my attempt at recreating it using Threejs.

<video src="docs/assets/videos/the-ocean/recreation.mp4" playsinline loop muted autoplay="autoplay"></video>
...
![](docs/assets/images/the-ocean/texture.jpeg)
...
![Ocean shader before and after sine-curve displacement](docs/assets/images/the-ocean/displacement.jpeg)*Ocean shader before and after sine-curve displacement*
...
<video src="docs/assets/videos/the-ocean/texture.mp4" playsinline loop muted autoplay="autoplay"></video>
...
![Sine curve](docs/assets/images/the-ocean/sine.jpeg)*Sine curve*
...
![Simple compound sine curve](docs/assets/images/the-ocean/compound-sine.jpeg)*Simple compound sine curve*
...
![More complex compound sine curve](docs/assets/images/the-ocean/complex-compound-sine.jpeg)*More complex compound sine curve*
...
<video src="docs/assets/videos/the-ocean/wireframe.mp4" playsinline loop muted autoplay="autoplay"></video>
...
<video src="docs/assets/videos/the-ocean/sine-noise.mp4" playsinline loop muted autoplay="autoplay"></video>
...
<video src="docs/assets/videos/the-ocean/sine-noise-accounted.mp4" playsinline loop muted autoplay="autoplay"></video>
...
<video src="docs/assets/videos/the-ocean/sine-noise-2d.mp4" playsinline loop muted autoplay="autoplay"></video>
...
<video src="docs/assets/videos/the-ocean/sine-noise-values.mp4" playsinline loop muted autoplay="autoplay"></video>
...
<video src="docs/assets/videos/the-ocean/final.mp4" playsinline loop muted autoplay="autoplay"></video>
...
[*Onto the next analysis — Fire and Haze!*](?fire-and-haze)
